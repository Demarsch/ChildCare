CREATE TABLE [dbo].[CommissionDecisions] (
    ...
    [NeedAllMembersInStage] BIT            CONSTRAINT [DF_CommissionDecisions_NeedAlllMemmbersInStage] DEFAULT ((0)) NOT NULL,
    ...
    CONSTRAINT [FK_CommissionDecisions_Users1] FOREIGN KEY ([InitiatorUserId]) REFERENCES [dbo].[Users] ([Id])
);
