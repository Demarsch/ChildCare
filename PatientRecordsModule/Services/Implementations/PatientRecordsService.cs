...
namespace Shared.PatientRecords.Services
{
    public class PatientRecordsService : IPatientRecordsService
    {
        ...
        public async Task<int> SaveRecordCommonDataAsync(int recordId, int recordTypeId, int personId, int visitId, int roomId, int periodId, int urgentlyId, DateTime beginDateTime,
