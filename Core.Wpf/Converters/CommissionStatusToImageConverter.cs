...
{
    public class CommissionStatusToImageConverter : IValueConverter
    {
        public static readonly CommissionStatusToImageConverter Instance = new CommissionStatusToImageConverter();
