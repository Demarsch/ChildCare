...
namespace Core.Data
{
    public partial class PersonDisability
    {
        ...
        protected bool Equals(PersonDisability other)
        {
            return Id == other.Id 
                && PersonId == other.PersonId 
                && DisabilityTypeId == other.DisabilityTypeId 
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((PersonDisability)obj);
        }
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                ...
                hashCode = (hashCode * 397) ^ DisabilityTypeId;
