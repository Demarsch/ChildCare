...
namespace Registry
{
    ...
    public partial class App
    {
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            var patientSearchViewModel = new PatientSearchViewModel(patientService, personService, log, dialogService, documentService, recordService, assignmentService, patientAssignmentListViewModel);
